...
public class JalaliCalendar extends Calendar {
    ...
    public static YearMonthDate gregorianToJalali(YearMonthDate gregorian) {
     ...
     public static String jalaliToGregorianString(String date){
         String[] dateParts = date.split("/");
         String year = dateParts[0];
         String month = dateParts[1];
         String day = dateParts[2];
         YearMonthDate yearMonthDate =  new YearMonthDate(Integer.parseInt(year) ,Integer.parseInt(month) - 1,Integer.parseInt(day));
         YearMonthDate gregorianDate = jalaliToGregorian(yearMonthDate);
         return gregorianDate.toString();
     }

     public static String stringGregorianToJalali(String date){
         ...
         String day = dateParts[2];
         YearMonthDate yearMonthDate =  new YearMonthDate(Integer.parseInt(year) ,Integer.parseInt(month) - 1,Integer.parseInt(day));
         YearMonthDate jalaliDate = gregorianToJalali(yearMonthDate);
    ...
    public static YearMonthDate jalaliToGregorian(YearMonthDate jalali) {
        ...
        return new YearMonthDate(gregorianYear, gregorianMonth + 1, gregorianDay);
